...
async function steamWorkshopUpdate( mod, changenote, description, debug = false ){
    return new Promise( (resolve, reject) => {
        ...
        // spawn process
        let updater = spawn( config.paths.steam_workshop_updater, [ 
            mod,
            path.resolve( "changenote.txt" ), 
            path.resolve( "description.txt") ], { stdio: "inherit" });
